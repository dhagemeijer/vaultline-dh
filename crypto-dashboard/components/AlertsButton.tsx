  ...
  return (
    <>
      ...
      >
        ...
        {activeCount > 0 && (
          <span className="absolute -right-0.5 -top-0.5 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-accent px-1 font-mono text-[10px] text-parchment">
            {activeCount}
          </span>
        )}
      </button>
